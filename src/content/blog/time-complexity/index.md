---
title: "시간 복잡도와 빅오 표기법"
description: "시간 복잡도와 이를 표현하기 위한 빅오 표기법"
date: "2022-09-12"
---

**시간 복잡도**란 어떤 알고리즘을 수행하는데 걸리는 시간을 설명하는 계산 복잡도를 말한다.

- 수행 시간은 컴퓨터 하드웨어, 프로그래밍 언어의 컴파일러에 따라 차이가 있을 수 있기 때문에 오직 **명령어의 실행횟수**만 고려한다.
- 시간 복잡도를 표기하는 대표적인 방법으로 최고 차항만 나타내는 **빅오 표기법**이 있다.
...
![빅오 정의에 대한 그래프](./big-o-formula.png)

### 빅오 표기법 종류

![빅오 표기법 종류](./big-o-complexity-chart.png)
